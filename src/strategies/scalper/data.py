...
class KlineFetcher:
    ...
    async def get_price(self, symbol: str) -> float:
        ...
        Sözleşme:
          ...
          * Sembol başına `_TICKER_PRICE_TTL_SECONDS` önbellek (safety turu
            başına en fazla bir istek).
        ...
        now = time.monotonic()
        if cached is not None and (now - cached[1]) < _TICKER_PRICE_TTL_SECONDS:
            return cached[0]
